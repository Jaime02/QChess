...
from QChess.src.game_widget import GameWidget
from QChess.src.change_pieces_window import ChangePiecesWindow
...
class GameWindow(QMainWindow):
    def __init__(self, app):
        ...
        self.change_pieces_action.triggered.connect(self.change_pieces_window.show)
